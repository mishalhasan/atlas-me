    ...
    <div className="flex flex-col gap-2 min-w-20 min-h-29">
      {loading ? (
        ...
        <>
          ...
          <div className="flex gap-2">
            <button
              className="w-full bg-[rgba(212,168,67,0.1)] border-[#d4a843] border-[1.5px] hover:bg-[#d4a843]/20 text-[#92700a] font-medium rounded-md px-1 py-1 font-sans cursor-pointer"
              onClick={() => handleAddPin(searchResult, "wishlist")}
            >
              <Heart className="inline-flex items-center gap-2" size={15} />{" "}
              Wishlist
